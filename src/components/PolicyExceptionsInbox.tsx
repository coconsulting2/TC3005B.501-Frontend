            ...
            {items.map((ex) => (
              <tr key={ex.exceptionId}>
                ...
                <td style={td}>
                  ...
                  <Button variant="outline" color="warning" size="small" onClick={() => setDecisionFor({ id: ex.exceptionId, decision: "REJECTED" })}>
                    Rechazar
                  </Button>
                </td>
              </tr>
        ...
        >
          <div style={{ display: "grid", gap: "0.75rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.5rem", justifyContent: "flex-end" }}>
              <Button variant="outline" color="primary" onClick={() => setDecisionFor(null)}>Cancelar</Button>
              <Button variant="filled" color={decisionFor.decision === "APPROVED" ? "primary" : "warning"} onClick={decide}>
                Confirmar
              </Button>
            </div>
          </div>
