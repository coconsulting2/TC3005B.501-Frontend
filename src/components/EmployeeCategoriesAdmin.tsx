        ...
        <tbody>
          {items.map((c) => (
            <tr key={c.categoryId}>
              ...
              <td style={td}>
                <Button variant="outline" color="primary" size="small" onClick={() => openEdit(c)}>Editar</Button>{" "}
                <Button variant="outline" color="warning" size="small" onClick={() => onDelete(c)}>Desactivar</Button>
              </td>
            </tr>
          ))}
        </tbody>
