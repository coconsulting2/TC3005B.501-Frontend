...
export const roleRoutes: Record<UserRole, string[]> = {
  ...
  'N1': ['/dashboard', '/perfil-usuario', '/solicitudes-autorizador', '/crear-solicitud','/historial','/reembolso','/solicitudes-draft','/comprobar-gastos','/completar-draft/*','/editar-solicitud/*','/comprobar-solicitud/*','/autorizaciones','/aprobaciones','/detalles-solicitud/*','/autorizar-solicitud/*','/subir-comprobante/*'],
  'N2': ['/dashboard', '/perfil-usuario', '/solicitudes-autorizador', '/crear-solicitud','/historial','/reembolso','/solicitudes-draft','/comprobar-gastos','/completar-draft/*','/editar-solicitud/*','/comprobar-solicitud/*','/autorizaciones','/aprobaciones','/detalles-solicitud/*','/autorizar-solicitud/*','/subir-comprobante/*'],
